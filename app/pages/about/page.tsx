...
export default function about() {
  return (
    <div className="bg-gray-800 px-4 py-20 sm:py-24 text-center font-sans">
      ...
      <div className="mt-6">
        <Link href="/pages/job-requisitions" className="text-blue-400 hover:underline text-sm sm:text-base">
          job-requisitions
        </Link>
      </div>
      <div className="mt-6">
      ...
      <div className="mt-6">
        <Link href="/pages/candidate-ranking" className="text-blue-400 hover:underline text-sm sm:text-base">
          candidate-ranking
        </Link>
      </div>
      <div className="mt-6">
